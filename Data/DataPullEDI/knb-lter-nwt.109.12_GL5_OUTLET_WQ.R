...
# Package ID: knb-lter-nwt.109.12 Cataloging System:https://pasta.edirepository.org.
# Data set title: Stream water chemistry data for Green Lake 5 outlet, 1984 - ongoing..
...
inUrl1  <- "https://pasta.lternet.edu/package/data/eml/knb-lter-nwt/109/12/9989a5ac3cab14e5dcb87eff9c7981c3" 
infile1 <- tempfile()
...
dt1$pH <- ifelse((trimws(as.character(dt1$pH))==trimws("NV")),NA,dt1$pH)               
suppressWarnings(dt1$pH <- ifelse(!is.na(as.numeric("NV")) & (trimws(as.character(dt1$pH))==as.character(as.numeric("NV"))),NA,dt1$pH))
...
dt1$acid <- ifelse((trimws(as.character(dt1$acid))==trimws("NSS")),NA,dt1$acid)               
suppressWarnings(dt1$acid <- ifelse(!is.na(as.numeric("NSS")) & (trimws(as.character(dt1$acid))==as.character(as.numeric("NSS"))),NA,dt1$acid))
dt1$acid <- ifelse((trimws(as.character(dt1$acid))==trimws("u")),NA,dt1$acid)               
suppressWarnings(dt1$acid <- ifelse(!is.na(as.numeric("u")) & (trimws(as.character(dt1$acid))==as.character(as.numeric("u"))),NA,dt1$acid))
dt1$acid <- ifelse((trimws(as.character(dt1$acid))==trimws("EQCL")),NA,dt1$acid)               
suppressWarnings(dt1$acid <- ifelse(!is.na(as.numeric("EQCL")) & (trimws(as.character(dt1$acid))==as.character(as.numeric("EQCL"))),NA,dt1$acid))
...
dt1$H.plus. <- ifelse((trimws(as.character(dt1$H.plus.))==trimws("NV")),NA,dt1$H.plus.)               
suppressWarnings(dt1$H.plus. <- ifelse(!is.na(as.numeric("NV")) & (trimws(as.character(dt1$H.plus.))==as.character(as.numeric("NV"))),NA,dt1$H.plus.))
...
dt1$K.plus. <- ifelse((trimws(as.character(dt1$K.plus.))==trimws("NV")),NA,dt1$K.plus.)               
suppressWarnings(dt1$K.plus. <- ifelse(!is.na(as.numeric("NV")) & (trimws(as.character(dt1$K.plus.))==as.character(as.numeric("NV"))),NA,dt1$K.plus.))
...
dt1$NO3.hyphen. <- ifelse((trimws(as.character(dt1$NO3.hyphen.))==trimws("<0.161")),NA,dt1$NO3.hyphen.)               
suppressWarnings(dt1$NO3.hyphen. <- ifelse(!is.na(as.numeric("<0.161")) & (trimws(as.character(dt1$NO3.hyphen.))==as.character(as.numeric("<0.161"))),NA,dt1$NO3.hyphen.))
...
dt1$cat_sum <- ifelse((trimws(as.character(dt1$cat_sum))==trimws("NSS")),NA,dt1$cat_sum)               
suppressWarnings(dt1$cat_sum <- ifelse(!is.na(as.numeric("NSS")) & (trimws(as.character(dt1$cat_sum))==as.character(as.numeric("NSS"))),NA,dt1$cat_sum))
dt1$cat_sum <- ifelse((trimws(as.character(dt1$cat_sum))==trimws("u")),NA,dt1$cat_sum)               
suppressWarnings(dt1$cat_sum <- ifelse(!is.na(as.numeric("u")) & (trimws(as.character(dt1$cat_sum))==as.character(as.numeric("u"))),NA,dt1$cat_sum))
dt1$cat_sum <- ifelse((trimws(as.character(dt1$cat_sum))==trimws("EQCL")),NA,dt1$cat_sum)               
suppressWarnings(dt1$cat_sum <- ifelse(!is.na(as.numeric("EQCL")) & (trimws(as.character(dt1$cat_sum))==as.character(as.numeric("EQCL"))),NA,dt1$cat_sum))
...
dt1$chg_bal <- ifelse((trimws(as.character(dt1$chg_bal))==trimws("NSS")),NA,dt1$chg_bal)               
suppressWarnings(dt1$chg_bal <- ifelse(!is.na(as.numeric("NSS")) & (trimws(as.character(dt1$chg_bal))==as.character(as.numeric("NSS"))),NA,dt1$chg_bal))
dt1$chg_bal <- ifelse((trimws(as.character(dt1$chg_bal))==trimws("u")),NA,dt1$chg_bal)               
suppressWarnings(dt1$chg_bal <- ifelse(!is.na(as.numeric("u")) & (trimws(as.character(dt1$chg_bal))==as.character(as.numeric("u"))),NA,dt1$chg_bal))
dt1$chg_bal <- ifelse((trimws(as.character(dt1$chg_bal))==trimws("EQCL")),NA,dt1$chg_bal)               
suppressWarnings(dt1$chg_bal <- ifelse(!is.na(as.numeric("EQCL")) & (trimws(as.character(dt1$chg_bal))==as.character(as.numeric("EQCL"))),NA,dt1$chg_bal))
...
dt1$TDN <- ifelse((trimws(as.character(dt1$TDN))==trimws("u")),NA,dt1$TDN)               
suppressWarnings(dt1$TDN <- ifelse(!is.na(as.numeric("u")) & (trimws(as.character(dt1$TDN))==as.character(as.numeric("u"))),NA,dt1$TDN))
...
dt1$TDN <- ifelse((trimws(as.character(dt1$TDN))==trimws("<0.56")),NA,dt1$TDN)               
suppressWarnings(dt1$TDN <- ifelse(!is.na(as.numeric("<0.56")) & (trimws(as.character(dt1$TDN))==as.character(as.numeric("<0.56"))),NA,dt1$TDN))
...
dt1$DON <- ifelse((trimws(as.character(dt1$DON))==trimws("NV")),NA,dt1$DON)               
suppressWarnings(dt1$DON <- ifelse(!is.na(as.numeric("NV")) & (trimws(as.character(dt1$DON))==as.character(as.numeric("NV"))),NA,dt1$DON))
...
dt1$IN <- ifelse((trimws(as.character(dt1$IN))==trimws("NSS")),NA,dt1$IN)               
suppressWarnings(dt1$IN <- ifelse(!is.na(as.numeric("NSS")) & (trimws(as.character(dt1$IN))==as.character(as.numeric("NSS"))),NA,dt1$IN))
...
dt1$IN <- ifelse((trimws(as.character(dt1$IN))==trimws("EQCL")),NA,dt1$IN)               
suppressWarnings(dt1$IN <- ifelse(!is.na(as.numeric("EQCL")) & (trimws(as.character(dt1$IN))==as.character(as.numeric("EQCL"))),NA,dt1$IN))
...
dt1$DOC <- ifelse((trimws(as.character(dt1$DOC))==trimws("EQCL")),NA,dt1$DOC)               
suppressWarnings(dt1$DOC <- ifelse(!is.na(as.numeric("EQCL")) & (trimws(as.character(dt1$DOC))==as.character(as.numeric("EQCL"))),NA,dt1$DOC))
...
write.csv(GL5_OUTLET_WQ, 'Data/DataPullEDI/knb-lter-nwt.109.12_GL5_OUTLET_WQ.csv')
