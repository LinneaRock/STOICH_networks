...
# Package ID: knb-lter-nwt.103.15 Cataloging System:https://pasta.edirepository.org.
# Data set title: Stream water chemistry data for Albion site, 1982 - ongoing..
...
inUrl1  <- "https://pasta.lternet.edu/package/data/eml/knb-lter-nwt/103/15/413c3eb5a1a52e3ce2f9e52b3565aadd" 
infile1 <- tempfile()
...
write.csv(ALB_CAMP_WQ, 'Data/DataPullEDI/knb-lter-nwt.103.15_ALB_CAMP_WQ.csv')
