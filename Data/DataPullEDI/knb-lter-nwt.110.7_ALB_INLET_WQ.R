...
# Package ID: knb-lter-nwt.110.7 Cataloging System:https://pasta.edirepository.org.
# Data set title: Stream water chemistry data for Lake Albion inlet, 1984 - 2004..
...
inUrl1  <- "https://pasta.lternet.edu/package/data/eml/knb-lter-nwt/110/7/1ee20eb448839892084f96e1898be094" 
infile1 <- tempfile()
...
write.csv(ALB_INLET_WQ, 'Data/DataPullEDI/knb-lter-nwt.110.7_ALB_INLET_WQ.csv')
