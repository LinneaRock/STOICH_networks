...
bootstrap_all$param <- factor(bootstrap_all$param, levels=c('DON_umolL','DOP_umolL','don.dop', 'IN_umolL','IP_umolL','in.ip', 'PN_umolL','PP_umolL', 'pn.pp','TDN_umolL','TDP_umolL','tdn.tdp','TN_umolL','TP_umolL','tn.tp'), labels = c(expression(phi*'(DON'~mu*mol*L^-1*')'), expression(phi*'(DOP'~mu*mol*L^-1*')'), expression(phi*'(DON:DOP)'), expression(phi*'(IN'~mu*mol*L^-1*')'), expression(phi*'(IP'~mu*mol*L^-1*')'), expression(phi*'(IN:IP)'), expression(phi*'(PN'~mu*mol*L^-1*')'), expression(phi*'(PP'~mu*mol*L^-1*')'),  expression(phi*'(PN:PP)'), expression(phi*'(TDN'~mu*mol*L^-1*')'), expression(phi*'(TDP'~mu*mol*L^-1*')'),expression(phi*'(TDN:TDP)'), expression(phi*'(TN'~mu*mol*L^-1*')'), expression(phi*'(TP'~mu*mol*L^-1*')'), expression(phi*'(TN:TP)'))) 



k_densities_all$param <- factor(k_densities_all$param, levels=c('DON_umolL','DOP_umolL','don.dop', 'IN_umolL','IP_umolL','in.ip', 'PN_umolL','PP_umolL', 'pn.pp','TDN_umolL','TDP_umolL','tdn.tdp','TN_umolL','TP_umolL','tn.tp'), labels = c(expression(phi*'(DON'~mu*mol*L^-1*')'), expression(phi*'(DOP'~mu*mol*L^-1*')'), expression(phi*'(DON:DOP)'), expression(phi*'(IN'~mu*mol*L^-1*')'), expression(phi*'(IP'~mu*mol*L^-1*')'), expression(phi*'(IN:IP)'), expression(phi*'(PN'~mu*mol*L^-1*')'), expression(phi*'(PP'~mu*mol*L^-1*')'),  expression(phi*'(PN:PP)'), expression(phi*'(TDN'~mu*mol*L^-1*')'), expression(phi*'(TDP'~mu*mol*L^-1*')'),expression(phi*'(TDN:TDP)'), expression(phi*'(TN'~mu*mol*L^-1*')'), expression(phi*'(TP'~mu*mol*L^-1*')'), expression(phi*'(TN:TP)'))) 


invsout_all$param <- factor(invsout_all$param, levels=c('DON_umolL','DOP_umolL','don.dop', 'IN_umolL','IP_umolL','in.ip', 'PN_umolL','PP_umolL', 'pn.pp','TDN_umolL','TDP_umolL','tdn.tdp','TN_umolL','TP_umolL','tn.tp'), labels = c(expression(phi*'(DON'~mu*mol*L^-1*')'), expression(phi*'(DOP'~mu*mol*L^-1*')'), expression(phi*'(DON:DOP)'), expression(phi*'(IN'~mu*mol*L^-1*')'), expression(phi*'(IP'~mu*mol*L^-1*')'), expression(phi*'(IN:IP)'), expression(phi*'(PN'~mu*mol*L^-1*')'), expression(phi*'(PP'~mu*mol*L^-1*')'),  expression(phi*'(PN:PP)'), expression(phi*'(TDN'~mu*mol*L^-1*')'), expression(phi*'(TDP'~mu*mol*L^-1*')'),expression(phi*'(TDN:TDP)'), expression(phi*'(TN'~mu*mol*L^-1*')'), expression(phi*'(TP'~mu*mol*L^-1*')'), expression(phi*'(TN:TP)'))) 
