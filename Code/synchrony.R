...
ggplot(sync_dist_all, aes(as.numeric(distance_Km), correlation)) +
  geom_point() +
...
# data:  (arrange(sync_dist_mean_N, distance_Km))$meancorr
# z = -3.7516, n = 48, p-value = 0.0001757
# alternative hypothesis: true z is not equal to 0
# 95 percent confidence interval:
#   -0.028107143 -0.007164706
# sample estimates:
#   Sen's slope 
# -0.01776833 

ggplot(sync_dist_mean_N, aes(as.numeric(distance_Km), meancorr)) +
  geom_point() +
  #geom_smooth(se=FALSE) +
  theme_classic() +
...
# data:  (arrange(sync_dist_mean_P, distance_Km))$meancorr
# z = -1.7333, n = 48, p-value = 0.08304
# alternative hypothesis: true z is not equal to 0
# 95 percent confidence interval:
#   -0.016339216  0.001086957
# sample estimates:
#   Sen's slope 
# -0.006714643 


ggplot(sync_dist_mean_P, aes(as.numeric(distance_Km), meancorr)) +
  geom_point() +
  #geom_smooth(se=FALSE) +
  theme_classic() +
...
# data:  (arrange(sync_dist_mean_stoich, distance_Km))$meancorr
# z = -4.0897, n = 48, p-value = 4.319e-05
# alternative hypothesis: true z is not equal to 0
# 95 percent confidence interval:
#   -0.02495476 -0.01049091
# sample estimates:
#   Sen's slope 
#-0.01678556 
...
ggplot(sync_dist_mean_stoich, aes(as.numeric(distance_Km), meancorr)) +
  geom_point() +
  #geom_smooth(se=FALSE) +
  theme_classic() +
